...
public class TimerStartedEventArgs(
    ...
    int plannedMinutes,
    DateTime startedAt,
    int? tfsWorkItemId = null) : EventArgs
{
    ...
    public int? TfsWorkItemId { get; } = tfsWorkItemId;
}
...
public interface ITimerStateService
{
    ...
    void NotifyTimerStarted(int taskId, string taskTitle, int previousSpentMinutes, int plannedMinutes, DateTime startedAt, int? tfsWorkItemId = null);
